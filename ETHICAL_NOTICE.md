...
## 1. Purpose and Scope
This document expresses the **ethical intent and community values** of Topologiq in a way that aligns to the **ethical intent and community values** of the TQEC (Topological Quantum Error Correction) project.
...
Topologiq is an open-source software project made available for the advancement of **large-scale fault-tolerant quantum computing**, particularly based on **surface code** and  **lattice surgery**.
...
While these are not legal prohibitions, the maintainers suggest that users and contributors **refrain from engaging in, supporting, or facilitating** such activities.
...
## 5. Adherence to Contributor Guidelines
Pull requests and issues are more than welcomed!

See [CONTRIBUTING](./CONTRIBUTING.md) for specific guidelines and instructions.

## 6. Disclaimer of Warranty and Liability
As detailed in the [LICENSE](./LICENSE), this software is provided **“AS IS”**, without any express or implied warranties, including but not limited to warranties of merchantability, fitness for a particular purpose, or non-infringement.
...
## 7. Final Remarks
Topologiq is part of a shared global effort to advance fault-tolerant quantum computing for peaceful and ethical applications. We welcome collaboration from researchers, educators, and institutions who share this vision.
